...
* Create an [issue](https://github.com/jonnitto/Carbon.Link/issues) on GitHub, if you have found a bug
...
* Submit an [issue](https://github.com/jonnitto/Carbon.Link/issues), assuming one does not already exist.
